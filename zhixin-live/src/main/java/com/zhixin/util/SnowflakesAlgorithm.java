...
public class SnowflakesAlgorithm {
    ...
    public SnowflakesAlgorithm(long workerId, long datacenterId, long sequence){
    ...
    public static void main(String[] args) {
        for (int i = 0;i<100;i++){
            System.out.println(SnowflakesAlgorithm.getGenerateId());
        }

    }

    public static long getRandomCode(){
        SnowflakesAlgorithm worker = new SnowflakesAlgorithm(1,1,1);
